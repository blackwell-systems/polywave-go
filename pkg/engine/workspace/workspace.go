// Code generated by wave agent stub — replaced by Agent A's workspace.go at merge.
// This file exists only to allow wave1-agent-C to build and test independently.
package workspace
